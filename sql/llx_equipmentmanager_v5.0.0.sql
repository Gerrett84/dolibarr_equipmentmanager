...
ALTER TABLE llx_equipmentmanager_equipment
    ...
    ADD COLUMN IF NOT EXISTS fire_protection TINYINT UNSIGNED NULL AFTER battery_replacement_cycle,
    ADD COLUMN IF NOT EXISTS smoke_detector_install_month TINYINT UNSIGNED NULL AFTER fire_protection,
