 ...
 */
class pdf_cyan_objektadresse extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "cyan_objektadresse";
		$this->description = $langs->trans('DocModelCyanDescription').' (mit Objektadresse)';
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		*/
		...
		if ($showaddress) {
			...
			$pdf->SetFont('', 'B', $default_font_size);
			// @phan-suppress-next-line PhanPluginSuspiciousParamOrder
			$pdf->MultiCell($widthrecbox - 4, 2, $carac_client_name, 0, $ltrdirection);
