 ...
 */
class pdf_crabe_objektadresse extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabe_objektadresse";
		$this->description = $langs->trans('PDFCrabeDescription').' (mit Objektadresse)';
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($showaddress) {
			...
			// Pre-load Objektadresse to adjust frame height
			$carac_objektadresse = '';
			...
			// Increase frame height if Objektadresse exists
